<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            ...
            <?php } ?>
            <?php if($this->session->flashdata('post-del-fail-flash')) { ?>
                <div class="alert alert-success">
                    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                    <?php print $this->session->flashdata('post-del-fail-flash'); ?>
                </div>
            <?php } ?>
                        ...
                        <?php foreach($posts as $value): ?>
                            <tr>
                                ...
                                <td class="text-right" style="width: 100px;">
                                    ...
                                    <a href="<?php print base_url(); ?>admin/posts/delete/<?php print $value->post_id; ?>" class="btn btn-danger btn-xs" onclick="return confirm('Are you sure want ot delete?');"><i class="glyphicon glyphicon-remove"></i></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                        </tbody>
